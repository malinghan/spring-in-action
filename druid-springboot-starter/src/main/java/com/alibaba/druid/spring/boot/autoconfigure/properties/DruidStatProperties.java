...
public class DruidStatProperties {
    ...
    //add by magic~  输出项目名称，http慢接口，service慢接口
    private String projectName="xrxs";
    private long slowHttpMillis = 3000L;
    private long slowServiceMillis = 3000L;
