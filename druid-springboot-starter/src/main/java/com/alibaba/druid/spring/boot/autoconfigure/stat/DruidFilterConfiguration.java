...
import com.alibaba.druid.spring.boot.autoconfigure.filter.SomeStatFilter;
...
public class DruidFilterConfiguration {
    ...
    public StatFilter statFilter(DruidStatProperties properties) {
        return new SomeStatFilter(properties.getProjectName());
    }
