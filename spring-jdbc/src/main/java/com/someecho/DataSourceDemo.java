 ...
 * @Package com.someecho
 * @Description:
 * @date Date : 2020年03月21日 9:48 PM
 **/
@Configuration
@EnableTransactionManagement
@ComponentScan("com.someecho")
...
//                new ClassPathXmlApplicationContext("applicationContext*.xml");
        AnnotationConfigApplicationContext applicationContext = new AnnotationConfigApplicationContext(DataSourceDemo.class);
